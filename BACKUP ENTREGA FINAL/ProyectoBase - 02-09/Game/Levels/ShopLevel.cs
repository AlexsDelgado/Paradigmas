...
namespace Game
{
    public class ShopLevel : Level
    {
        ...
        public ShopLevel(Texture background, LevelType p_levelType) : base(background, p_levelType)
        {
            ...
            {
                ("Bat", "GameAssets/Personajes/enemy.png", "GameAssets/Personajes/bat.png", 40, 7, 2, enemySpawn,"GameAssets/Personajes/batIcon.png"),
                ("Imp", "GameAssets/Personajes/enemy2.png", "GameAssets/Personajes/enemy2Combat.png", 60, 14, 1, enemySpawn,"GameAssets/Personajes/enemy2Icon.png"),
                ("Orc", "GameAssets/Personajes/enemy3.png", "GameAssets/Personajes/enemy3Combat.png", 90, 10, 1, enemySpawn,"GameAssets/Personajes/enemy3Icon.png"),
                ("Slime", "GameAssets/Personajes/enemy4.png", "GameAssets/Personajes/enemy4Combat.png", 75, 5, 1, enemySpawn,"GameAssets/Personajes/enemy4Icon.png"),
                ("Minotaur", "GameAssets/Personajes/enemy5.png", "GameAssets/Personajes/enemy5Combat.png", 100, 15, 1, enemySpawn,"GameAssets/Personajes/enemy5Icon.png")
        };
        ...
        public void GetEnemy()
        {
            ...
            Console.WriteLine($"Aparecio un {enemyRandom.name}");
